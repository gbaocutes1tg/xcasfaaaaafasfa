...
function Facebook() {
  setTimeout(function() {
    window.open('https://www.facebook.com/caogiabaoo', 'ultimate')},
  100);
}
function Discord() {
  setTimeout(function() {
    window.open('https://discords.com/bio/p/gbaodz', 'ultimate')},
  100);
}
function Telegram() {
  setTimeout(function() {
    window.open('https://t.me/luckervices', 'ultimate')},
  100);
}
